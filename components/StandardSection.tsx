...
export default function AuroStandardSection() {
  const features = [
    {
      id: 1,
      icon: <Droplets className="w-8 h-8 text-[#E7C57D]" />,
    ...
    {
      id: 2,
      icon: <Sparkles className="w-8 h-8 text-[#E7C57D]" />,
    ...
    {
      id: 3,
      icon: <Leaf className="w-8 h-8 text-[#E7C57D]" />,
  ...
  return (
    <section className="py-24 px-6 bg-gradient-to-b bg-amber-950">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-4xl font-bold text-[#E7C57D] mb-12"
        >
          The Auro Standard
        </motion.h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 mt-12">
          {features.map((f) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-amber-900 border border-amber-800 shadow-sm hover:shadow-md rounded-2xl p-8 transition-all duration-300"
            >
