...
export default function StatsSection() {
  ...
  const stats = [
    {
      icon: <FaPaw className="text-[#E7C57D] text-4xl mb-3" />,
    ...
    {
      icon: <FaSmile className="text-[#E7C57D] text-4xl mb-3" />,
    ...
    {
      icon: <FaHeart className="text-[#E7C57D] text-4xl mb-3" />,
    ...
    {
      icon: <FaLeaf className="text-[#E7C57D] text-4xl mb-3" />,
  ...
  return (
    ...
    >
      {/* Background glow */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-t from-[#E7C57D]/15 via-transparent to-transparent blur-3xl"
      ...
      <div className="relative z-10 text-center mb-16">
        ...
        <div className="mt-6 w-full h-[1px] mx-auto bg-gradient-to-r from-transparent via-[#E7C57D] to-transparent" />
      </div>
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 max-w-6xl mx-auto text-center">
        {stats.map((stat, index) => (
          ...
          >
            {stat.icon}
            <h3 className="text-4xl md:text-5xl font-semibold text-brandGold">
              {startCounting ? (
